...
Informatik und Informationswissenschaft unterstützen mit ihrer Expertise die Erstellung von Open Educational Resources (OER) für die beiden Anwendungsdomänen Digital Humanities und Verwaltungswissenschaft. 
Dabei werden auf Basis eines Datenkompetenzframeworks OER in Form von JupyterNotebooks erstellt, die auf Fallstudien basieren, um Forschungsprozesse möglichst realistisch abzubilden. Die Fallstudien nehmen die drei Datentypen Bewegtes Bild, Tabelle und Text in den Blick, die für die in den Anwendungsdomänen repräsentativ sind.
