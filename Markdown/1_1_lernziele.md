...
```
<!-- END: Datenaufbereitung I - Organisation und Strukturierung -->

<!-- START: Datenaufbereitung II - Analyse und Reproduzierbarkeit -->
```{admonition} [Lernziel: Datenanalyse und -reproduzierbarkeit](Datenaufbereitung2)
:class: lernziele
<!-- learning-goal: Datenanalyse und -reproduzierbarkeit -->
...
<!-- competency: 4.1 Datenanalyse | bloom: 2 Verstehen -->
...
<!-- competency: 4.1 Datenanalyse | bloom: 2 Verstehen -->
```
<!-- END: Datenaufbereitung II - Analyse und Reproduzierbarkeit -->
